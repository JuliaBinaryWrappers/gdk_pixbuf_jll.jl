# Autogenerated wrapper script for gdk_pixbuf_jll for aarch64-apple-darwin
...
JLLWrappers.@declare_library_product(libgdkpixbuf, "@rpath/libgdk_pixbuf-2.0.0.dylib")
function __init__()
